...
|-----|------|----------|---------------|
| **Groq** | [console.groq.com](https://console.groq.com) | Chat IA principal | 30 req/min |
| **Mistral** | [console.mistral.ai](https://console.mistral.ai) | Fallback de IA | 10 req/min |
| **Hugging Face** | [huggingface.co/settings/tokens](https://huggingface.co/settings/tokens) | Imagens e áudio | Ilimitado (rate limit) |
...
git branch -M main
git remote add origin https://github.com/teu-usuario/supreme-bot.git
